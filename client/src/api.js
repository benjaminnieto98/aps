...
export const makeDirectOffer = (id, amount) => api.post(`/players/${id}/offer`, { amount })
...
export const acceptRaisedOffer = (id) => api.post(`/clause-offers/${id}/accept-raised`)
export const cancelOffer = (id) => api.post(`/clause-offers/${id}/cancel`)
...
export const getAllSwapOffers = (params = {}) => api.get('/swap-offers/all', { params })
